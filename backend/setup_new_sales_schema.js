...
async function setupNewSalesSchema() {
    ...
    await db.query(`
        CREATE TABLE sales_stage_2 (
            ...
            tqd_presentation_yn VARCHAR(50),
            tqd_presentation_upload VARCHAR(255),
            handoff_presales VARCHAR(50),
            cust_req_discovery TEXT,
            flp_yn VARCHAR(50),
            flp_upload VARCHAR(255),
            oem_presentation_yn VARCHAR(50),
    ...
    await db.query(`
        CREATE TABLE sales_stage_3 (
            ...
            boq_version_yn VARCHAR(50),
            boq_version_number VARCHAR(50),
    ...
    await db.query(`
        CREATE TABLE sales_stage_7 (
            id INT AUTO_INCREMENT PRIMARY KEY,
            opportunity_id INT NOT NULL,
            invoice_submission_yn VARCHAR(50),
