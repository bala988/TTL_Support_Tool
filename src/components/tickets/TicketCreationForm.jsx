...
export default function TicketCreationForm() {
  ...
  reply_to: "support@tutelartechlabs.com"
          ...
          // Don't block the UI for email failure, but maybe warn
          alert("Ticket created, but failed to send confirmation email. Check console.");
        }

        alert("Ticket created successfully!");
        navigate("/engineer/dashboard");
      } else {
        alert("Error creating ticket: " + (result.message || "Unknown error"));
      }
    } catch (error) {
